  ...
  <div class="app-container">
    <el-form ref="form" :model="form" label-width="120px">
      ...
      <el-form-item label="源地址">
        <el-input v-model="form.srcadd" type="textarea" style="width: 40%;"placeholder="例:10.1.1.1/32
10.1.1.2/32
10.1.1.3/32"/>
      </el-form-item>
      <el-form-item label="目的地址">
        <el-input v-model="form.desadd" type="textarea" style="width: 40%;" placeholder="例:8.8.8.8/32
223.5.5.5/32
119.29.29.29/32"/>
      </el-form-item>
      <el-form-item label="TCP端口">
        <el-input v-model="form.tcpport" type="textarea" style="width: 40%;" placeholder="例:53"/>
      </el-form-item>
      <el-form-item label="UDP端口">
        <el-input v-model="form.udpport" type="textarea" style="width: 40%;" placeholder="例:53"/>
      </el-form-item>
      <el-form-item>
        <el-button type="primary" @click="onSubmit">生成命令</el-button>
      </el-form-item>
      <el-form-item v-show="form.command" label="命令">
        <el-input v-show="form.command" v-model="form.command" type="textarea" />
